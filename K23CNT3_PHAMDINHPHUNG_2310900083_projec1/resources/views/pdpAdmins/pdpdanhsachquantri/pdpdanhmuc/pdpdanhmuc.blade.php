            ...
            <div class="col-md-4">
                <div class="card text-center shadow-lg">
                    <div class="card-body bg-primary text-white">
                        ...
                        <a href="/pdp-admins/pdpdanhsachquantri/pdpsanpham" class="btn btn-outline-light">Xem Sản Phẩm</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-lg">
                    <div class="card-body bg-info text-white">
                        ...
                        <a href="{{route('pdpAdmins.pdpdanhsachquantri..danhmuc.tintuc')}}" class="btn btn-outline-light">Xem Tin Tức</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card text-center shadow-lg">
                    <div class="card-body bg-success text-white">
                        ...
                        <a href="/pdp-admins/pdpdanhsachquantri/pdpnguoidung" class="btn btn-outline-light">Xem Người Dùng</a>
                    </div>
                </div>
            </div>
        </div>

                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <!-- Nút xem chi tiết -->
                            <a href="{{ route('pdpuser.show', $sanPham->id) }}" class="btn btn-primary btn-sm">Xem Chi Tiết</a>

                            <!-- Nút Mua và icon giỏ hàng -->
                            <a href="{{route('pdpuser.login')}} "   
                            ...
                            <!-- Thêm vào giỏ hàng -->
                            <a href="{{route('pdpuser.login')}}"><button type="button" class="btn btn-warning btn-sm add-to-cart-btn" data-id="{{ $sanPham->id }}" data-name="{{ $sanPham->pdpTenSanPham }}">

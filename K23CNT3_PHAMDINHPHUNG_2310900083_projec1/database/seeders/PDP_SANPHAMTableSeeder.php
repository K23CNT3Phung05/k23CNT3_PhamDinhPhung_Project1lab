...
class PDP_SANPHAMTableSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        DB::table('PDP_SANPHAM')->insert([
            'pdpMaSanPham' => 'SS001',
            'pdpTenSanPham' => 'SamSung Galaxy S24 Utral',
            'pdpHinhAnh' => asset('img/san_pham/SS001.jpg'),
            'pdpSoLuong' => 100,
            'pdpDonGia' => 699000,
            'pdpMaLoai' => 2,
            'pdpMoTa' => 'Tính năng mới trên siêu phẩm Samsung Galaxy S24 Ultra
...
Điều Khiển Camera là kết quả của sự kết hợp chặt chẽ giữa phần cứng và phần mềm, giúp nâng cao trải nghiệm camera trên dòng sản phẩm iPhone 16. Được trang bị công nghệ tiên tiến, với một công tắc chạm tạo nên trải nghiệm bấm, cảm biến lực có độ chính xác cao hỗ trợ những cử chỉ nhấn nhẹ và cảm biến điện dung dành cho tương tác cảm ứng. Điều Khiển Camera có thể mở máy ảnh, chụp ảnh và bắt đầu quay video một cách nhanh chóng để người dùng không bỏ lỡ bất kỳ khoảnh khắc nào. Giao diện camera mới giúp người dùng căn chỉnh khung hình và điều chỉnh các tùy chọn điều khiển khác, chẳng hạn như thu phóng, độ phơi sáng hoặc độ sâu trường ảnh, để chụp ảnh hoặc quay video tuyệt đẹp bằng cách trượt ngón tay trên Điều Khiển Camera. Ngoài ra, các nhà phát triển sẽ có thể đưa Điều Khiển Camera vào các ứng dụng của bên thứ ba như Snapchat.',
            'pdpTrangThai' => 0
        ]);
        
        DB::table('PDP_SANPHAM')->insert([
            'pdpMaSanPham' => 'HW001',
            'pdpTenSanPham' => 'Điện Thoại Huawei',
            'pdpHinhAnh' => asset('img/san_pham/HW001.jpg'),
            'pdpSoLuong' => 150,
            'pdpDonGia' => 590000,
            'pdpMaLoai' => 3,
            'pdpMoTa' => 'Huawei vừa chính thức công bố mẫu điện thoại Mate XT Ultimate Design, đánh dấu một bước đột phá trong công nghệ với thiết kế màn hình gập ba đầu tiên trên thế giới. Điều này không chỉ thể hiện tham vọng của Huawei trong việc dẫn đầu xu hướng công nghệ mà còn mở ra kỷ nguyên mới cho các thiết bị di động thông minh với khả năng biến đổi linh hoạt để phục vụ đa dạng nhu cầu người dùng.
